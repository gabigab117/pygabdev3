        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address",
                    models.CharField(
                        help_text="Rue", max_length=200, verbose_name="Adresse"
                    ),
                ),
                (
                    "zip_code",
                ...
                (
                    "created_at",
                    models.DateField(
                        auto_now_add=True, verbose_name="Création de la fiche"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "time_spent",
                    models.FloatField(
                        help_text="En centièmes", verbose_name="Temps passé"
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="invoices", to="customers.service"
                    ),
                ),
            ],
            options={
